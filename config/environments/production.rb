...
config.cache_store = :redis_cache_store, {
  url: begin
    ...
    puts "🔐 Redis Cache URL: #{scheme}://:#{'*' * 10}@#{cache_host}:#{cache_port}"
    puts "🔑 SSL enabled: #{use_ssl}"
    puts "📦 ENV CACHE_HOST: #{ENV['CACHE_HOST'].inspect}"
    puts "📦 ENV CACHE_PORT: #{ENV['CACHE_PORT'].inspect}"
    puts "📦 ENV CACHE_PASSWORD present: #{ENV['CACHE_PASSWORD'].present?}"
